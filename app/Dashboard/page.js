          ...
          <div className="container border mb-4 rounded-3 ps-4 pe-4">
            ...
            <div className="h5">
              ...
              <div className={`input-group mb-3 mt-2`}>
                <span className={`input-group-text  ${isDark ? "bg-dark text-white" : ""}`}>
                  {isDark ? <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="40px"
                    viewBox="0 -960 960 960"
                ...
                />
                  <button className={`input-group-text ${isDark ? "btn btn-outline-light" : ""}`} onClick={getDetails}>
                    Verify
                  </button>
              </div>
              ...
              <input
                ...
                disabled
                className={`form-control mt-2 focus:outline-1 disabled:bg-gray-100 disabled:border-gray-200 ${isDark ? "bg-dark text-white" : ""}`}
                placeholder="Wallet address will appear here"
              />
              <br></br>
              <label htmlFor="amount">Enter amount (in Ethers):</label>
              <input
                className={`form-control mb-3 mt-2 ${isDark ? "bg-dark text-white" : ""}`}
                name="amount"
                placeholder="0.01"
                value={amount}
            ...
            <div className="h5">
              ...
              <div>
                <input
                  ...
                  disabled
                  className={`focus:outline-1 disabled:bg-gray-100 disabled:border-gray-200 form-control mb-3 mt-2 ${isDark ? "bg-dark text-white" : ""}`}
